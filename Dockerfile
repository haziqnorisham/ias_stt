...
RUN apt-get update -y \
    && apt-get install -y --no-install-recommends gcc build-essential python3-dev libpcre3 libpcre3-dev\
...
RUN apt-get update -y \
    && apt-get install -y --no-install-recommends curl gcc build-essential python3-dev libpcre3 libpcre3-dev\
    && rm -rf /var/lib/apt/lists/*
