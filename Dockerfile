...
RUN apt-get update -y \
    && apt-get install -y --no-install-recommends gcc build-essential python3-dev libpcre3\
...
RUN apt-get update -y \
    && apt-get install -y --no-install-recommends curl gcc build-essential python3-dev libpcre3\
    && rm -rf /var/lib/apt/lists/*
